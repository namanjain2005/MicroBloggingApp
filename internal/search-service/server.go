...
// TODO i should more think how should i insert user and post such that it can be easily queried for elastic search
...
func (s *ServiceSearchServer) SearchUsers(ctx context.Context, req *pb.SearchUsersRequest) (*pb.SearchUsersResponse, error) {
	return SearchUser(ctx, s.elasticSearchClient, req)
}
