...
const (
	FollowService_FollowUser_FullMethodName       = "/social.FollowService/FollowUser"
	FollowService_UnfollowUser_FullMethodName     = "/social.FollowService/UnfollowUser"
	FollowService_IsFollowing_FullMethodName      = "/social.FollowService/IsFollowing"
	FollowService_BatchIsFollowing_FullMethodName = "/social.FollowService/BatchIsFollowing"
...
type FollowServiceClient interface {
	...
	BatchIsFollowing(ctx context.Context, in *BatchIsFollowingRequest, opts ...grpc.CallOption) (*BatchIsFollowingResponse, error)
...
func (c *followServiceClient) BatchIsFollowing(ctx context.Context, in *BatchIsFollowingRequest, opts ...grpc.CallOption) (*BatchIsFollowingResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BatchIsFollowingResponse)
	err := c.cc.Invoke(ctx, FollowService_BatchIsFollowing_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type FollowServiceServer interface {
	...
	BatchIsFollowing(context.Context, *BatchIsFollowingRequest) (*BatchIsFollowingResponse, error)
...
func (UnimplementedFollowServiceServer) BatchIsFollowing(context.Context, *BatchIsFollowingRequest) (*BatchIsFollowingResponse, error) {
...
func _FollowService_BatchIsFollowing_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchIsFollowingRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FollowServiceServer).BatchIsFollowing(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FollowService_BatchIsFollowing_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FollowServiceServer).BatchIsFollowing(ctx, req.(*BatchIsFollowingRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FollowService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _FollowService_BatchIsFollowing_Handler,
		},
		{
	...
	Metadata: "internal/social-service/social.proto",
}
