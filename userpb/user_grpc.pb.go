...
const (
	...
	UserService_ModifyBio_FullMethodName      = "/user.UserService/ModifyBio"
)
...
type UserServiceClient interface {
	...
	ModifyBio(ctx context.Context, in *ModifyBioRequest, opts ...grpc.CallOption) (*ModifyBioResponse, error)
}
...
func (c *userServiceClient) ModifyBio(ctx context.Context, in *ModifyBioRequest, opts ...grpc.CallOption) (*ModifyBioResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ModifyBioResponse)
	err := c.cc.Invoke(ctx, UserService_ModifyBio_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	ModifyBio(context.Context, *ModifyBioRequest) (*ModifyBioResponse, error)
...
func (UnimplementedUserServiceServer) ModifyBio(context.Context, *ModifyBioRequest) (*ModifyBioResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ModifyBio not implemented")
}
...
func _UserService_ModifyBio_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ModifyBioRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).ModifyBio(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_ModifyBio_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).ModifyBio(ctx, req.(*ModifyBioRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ModifyBio",
			Handler:    _UserService_ModifyBio_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "internal/user-service/user.proto",
}
